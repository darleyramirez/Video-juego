...
public class Main {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in); // ❌ Error: "scanner" con minúscula, debe ser "Scanner"
        ...
        nombreProgramador = scanner.nextLine(); // ✅ Cambiado de next() a nextLine() para aceptar nombres con espacios
        ...
        tarifaBase = 50.0; // ❌ Error: número mal escrito como "50,0,0", corregido a 50.0
        ...
        cliente2 = scanner.nextLine();
        System.out.print("Cliente 3: ");
        cliente3 = scanner.nextLine();
        ...
        pagoProyecto1 = (horasProyecto1 * tarifaHoraFinal + bonusCliente1); // ❌ Variables mal escritas ("horasProyec1", "bonusCliene1")
        pagoProyecto2 = (horasProyecto2 * tarifaHoraFinal + bonusCliente2); // ❌ "tarifaHoraFnal", "bonusCliene2"
        pagoProyecto3 = (horasProyecto3 * tarifaHoraFinal + bonusCliente3); // ❌ "bonusCliene3"
